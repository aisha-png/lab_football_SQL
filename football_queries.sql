...
SELECT COUNT(*) FROM matches 
WHERE ftr = 'D' AND division_code = 'N1' AND season >= 2010 AND season <= 2015;
...
SELECT SUM(fthg + ftag), division_code, season FROM matches 
